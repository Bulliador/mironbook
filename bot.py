...
START_MESSAGES = [
    ...
    "Как же быстро все моменты, всё что я делал с теплом и заботой — просто чтобы порадовать тебя, поддержать или сделать твой день лучше, — обесценилось в момент и стало скорее напрягать тебя.\n\n"
