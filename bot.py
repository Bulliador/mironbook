...
START_MESSAGES = [
    ...
    (1, "Самым неприятным оказалось не само расставание, а умалчивание про связь, и то, как быстро вернулся человек, исчезновение которого когда-то совпало с нашим сближением."),
]
