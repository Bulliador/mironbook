...
START_MESSAGES = [
    ...
    (1, "Немного странные последние действия от тебя, ну да ладно. Возможно, когда все это останется в прошлом, мы сможем снова нормально общаться."),
    (1, "Больше лезть, навязываться не буду. Не блокирую, оставляю все как есть."),
    (2, "Спасибо за все хорошее. Береги себя."),
    (16, "ЧС от Симхи не понял прикола конечно, ну да ладно. Привет ему"),
]
