...
START_MESSAGES = [
    ...
    (1, "Немного странные последние действия от тебя, ну да ладно. Возможно, когда-нибудь в будущем, когда все это останется позади, мы сможем снова нормально общаться. Писать не буду, оставлю все как есть."),
