...
START_MESSAGES = [
    ...
    (2, "Странно и немного больно видеть, как вещи, которые я делал с теплом и заботой — просто чтобы порадовать тебя, поддержать или сделать твой день лучше, — так быстро обесценились и в какой-то момент начали восприниматься совсем иначе."),
    (1, "🇩🇪 Беглецу привет."),
]
