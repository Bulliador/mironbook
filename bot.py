...
START_MESSAGES = [
    ...
    (3,
     ...
     "<b>UPD 13.09.2026</b>
     "</blockquote>"
     "Книга была передана ещё давно. Продолжения не будет."),
    (1, "Самым неприятным оказалось не само расставание, а то, как быстро могут обесцениться поступки, слова и моменты. Умалчивание о вашей связи и то, как быстро вернулся человек, исчезновение которого когда-то совпало с нашим сближением."),
    (5, "<blockquote><code>STATUS: CLOSED\n"
 "QUEST: FINISHED\n"
 "NEXT_CHAPTER: NONE</code></blockquote>"),
]
