...
START_MESSAGES = [
    ...
    (1, "Немного странные последние действия от тебя, ну да ладно. Возможно, когда все это останется позади, мы сможем снова нормально общаться."),
    (1, "Писать, навязываться, блокировать не буду, оставлю все как есть."),
    (2, "Спасибо за все. Береги себя."),
    (25, "Симхе привет кста"),
]
