...
START_MESSAGES = [
    ...
    (1, "Немного странные последние действия от тебя, ну да ладно. Возможно, когда все это останется позади, мы сможем снова нормально общаться. Писать не буду, оставлю все как есть."),
    (2, "Спасибо за все. Береги себя."),
    (5, "<s>Симхе привет кста<s>"),
]
